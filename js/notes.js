...
var _user$project$Notes$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('hello app'),
			_1: {ctor: '[]'}
		});
};
	...
	function (msg, model) {
		...
		return {
			...
			_1: _user$project$Notes$renderStaff(
				A2(_user$project$Notes$newNote, model.note, model.position))
		};
	});
var _user$project$Notes$Model = F2(
	function (a, b) {
		return {note: a, position: b};
	});
var _user$project$Notes$initialModel = A2(_user$project$Notes$Model, 'c', 4);
...
var _user$project$Notes$NewNote = {ctor: 'NewNote'};
