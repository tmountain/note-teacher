...
var _cuducos$elm_format_number$FormatNumber$addThousandSeparator = F2(
	function (locale, num) {
		var parts = A2(_elm_lang$core$String$split, locale.thousandSeparator, num);
		var firstPart = A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			_elm_lang$core$List$head(parts));
		var firstParts = function () {
			if (_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$String$length(firstPart),
				3) > 0) {
				var newFirstPart = A2(_elm_lang$core$String$dropRight, 3, firstPart);
				return {
					ctor: '::',
					_0: A2(_cuducos$elm_format_number$FormatNumber$addThousandSeparator, locale, newFirstPart),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$core$String$right, 3, firstPart),
						_1: {ctor: '[]'}
					}
				};
			} else {
...
var _cuducos$elm_format_number$FormatNumber$formattedNonZeroNumber = F2(
	function (locale, num) {
		var digits = _elm_lang$core$Basics$toString(num);
		var intDigits = A2(_elm_lang$core$String$dropRight, locale.decimals, digits);
		var decDigits = A2(_elm_lang$core$String$right, locale.decimals, digits);
		return _elm_lang$core$String$concat(
			{
				ctor: '::',
				_0: A2(_cuducos$elm_format_number$FormatNumber$addThousandSeparator, locale, intDigits),
				_1: {
					ctor: '::',
...
var _cuducos$elm_format_number$FormatNumber$formattedZero = function (locale) {
	return _elm_lang$core$String$concat(
		{
			ctor: '::',
			_0: '0',
			_1: {
				...
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$String$repeat, locale.decimals, '0'),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _cuducos$elm_format_number$FormatNumber$formattedNumber = F2(
	function (locale, num) {
		return _elm_lang$core$Native_Utils.eq(num, 0) ? _cuducos$elm_format_number$FormatNumber$formattedZero(locale) : A2(_cuducos$elm_format_number$FormatNumber$formattedNonZeroNumber, locale, num);
	});
var _cuducos$elm_format_number$FormatNumber$formatFloat = F2(
	function (locale, num) {
		var multiplier = Math.pow(10, locale.decimals);
		var digits = _elm_lang$core$Basics$round(
			A2(
				F2(
					function (x, y) {
						return x * y;
					}),
				_elm_lang$core$Basics$toFloat(multiplier),
				num));
		return A2(_cuducos$elm_format_number$FormatNumber$formattedNumber, locale, digits);
	});
var _cuducos$elm_format_number$FormatNumber$formatInt = F2(
	function (locale, num) {
		return A2(
			_cuducos$elm_format_number$FormatNumber$formatFloat,
			locale,
			_elm_lang$core$Basics$toFloat(num));
	});
var _cuducos$elm_format_number$FormatNumber$Locale = F3(
	function (a, b, c) {
...
var _user$project$Notes$viewStaff = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('staff'),
				_1: {
					ctor: '::',
...
var _user$project$Notes$pctCorrect = F2(
	function (right, wrong) {
		return _elm_lang$core$Native_Utils.eq(right, 0) ? 0 : ((right / (wrong + right)) * 100);
	});
var _user$project$Notes$defaultLocale = {decimals: 2, thousandSeparator: ',', decimalSeparator: '.'};
var _user$project$Notes$viewPct = function (model) {
	return A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('fa fa-percent'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(
				A2(
					_cuducos$elm_format_number$FormatNumber$formatFloat,
					_user$project$Notes$defaultLocale,
					A2(
						_user$project$Notes$pctCorrect,
						_elm_lang$core$Basics$toFloat(model.correct),
						_elm_lang$core$Basics$toFloat(model.incorrect)))),
			_1: {ctor: '[]'}
		});
};
var _user$project$Notes$instructions = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _user$project$Notes$viewPct(model),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Notes$F = {ctor: 'F'};
...
var _user$project$Notes$noteMapping = function ($int) {
	...
	switch (_p1) {
		...
		case 2:
			return _user$project$Notes$D;
		case 3:
			return _user$project$Notes$E;
		case 4:
			return _user$project$Notes$F;
		case 5:
			return _user$project$Notes$G;
		case 6:
			return _user$project$Notes$A;
		default:
			return _user$project$Notes$B;
	}
};
var _user$project$Notes$note = A2(
	_elm_lang$core$Random$map,
...
var _user$project$Notes$RandomNote = {ctor: 'RandomNote'};
var _user$project$Notes$viewRandomButton = A2(
	_elm_lang$html$Html$button,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onClick(_user$project$Notes$RandomNote),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _user$project$Notes$viewNoteButton = F2(
	function (noteValue, model) {
		return A5(
			_debois$elm_mdl$Material_Button$render,
			_user$project$Notes$Mdl,
			{
				ctor: '::',
				_0: 0,
				_1: {ctor: '[]'}
			...
			model.mdl,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Options$onClick(
							_user$project$Notes$Answer(noteValue)),
						_1: {ctor: '[]'}
					}
				}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					_elm_lang$core$Basics$toString(noteValue)),
				_1: {ctor: '[]'}
			});
	});
				...
				_0: A3(
					...
					A2(
						...
						},
						{
							...
							_1: {
								ctor: '::',
								_0: A2(_user$project$Notes$viewNoteButton, _user$project$Notes$G, model),
								_1: {
									ctor: '::',
									_0: A2(_user$project$Notes$viewNoteButton, _user$project$Notes$A, model),
									_1: {
										ctor: '::',
										_0: A2(_user$project$Notes$viewNoteButton, _user$project$Notes$B, model),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$Notes$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Notes$nav(model),
			_1: {
				ctor: '::',
				_0: _user$project$Notes$viewStaff,
				_1: {
					ctor: '::',
					_0: _user$project$Notes$footer(model),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Notes$viewAnswerButton = function (noteValue) {
	return A2(
		_elm_lang$html$Html$button,
		{
			ctor: '::',
...
var _user$project$Notes$randomNoteCmd = A2(_elm_lang$core$Random$generate, _user$project$Notes$NewNote, _user$project$Notes$note);
var _user$project$Notes$newNoteMsg = F2(
	function (noteValue, model) {
		return _elm_lang$core$Native_Utils.eq(noteValue, model.note) ? {ctor: '_Tuple2', _0: model, _1: _user$project$Notes$randomNoteCmd} : {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{note: noteValue}),
...
var _user$project$Notes$answerMsg = F2(
	function (noteValue, model) {
		return _elm_lang$core$Native_Utils.eq(noteValue, model.note) ? {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{correct: model.correct + 1}),
			_1: _user$project$Notes$randomNoteCmd
		} : {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
...
var _user$project$Notes$main = _elm_lang$html$Html$program(
	{init: _user$project$Notes$init, view: _user$project$Notes$view, update: _user$project$Notes$update, subscriptions: _user$project$Notes$subscriptions})();

var Elm = {};
Elm['Notes'] = Elm['Notes'] || {};
if (typeof _user$project$Notes$main !== 'undefined') {
    _user$project$Notes$main(Elm['Notes'], 'Notes', undefined);
}
